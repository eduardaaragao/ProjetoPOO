...
class Virus
{
	...
	public:
		...
		Virus(string nome, short int raio_contagio, short int taxa_contagio, short int perigosidade, short int taxa_cura ,Data* data_inicio);
		virtual ~Virus();
		...
		short int Get_Taxa_Cura() { return Taxa_Cura; }
